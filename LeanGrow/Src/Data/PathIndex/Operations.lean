...
| nil
| done (_ : PaIn IdxCollType) (nx : mergeT IdxCollType)
| sig1 (nx : mergeT IdxCollType) | sig2 (nx : mergeT IdxCollType) | sig3 (nx : mergeT IdxCollType)
| apa (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType)
| laf (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType) | laa (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType)
| alf (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType) | ala (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType)
| lef (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType) | lea (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType) | lez (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType)
| projPre (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType)
| projPost (name : ByteArray) (idx : Nat) (is : IdxCollType) (nx : mergeT IdxCollType)
| proofsOf (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType)
| proofs (_ _ : PaIn IdxCollType) (nx : mergeT IdxCollType)
deriving Inhabited
...
partial def mergeDown
  (union : IdxCollType → IdxCollType → IdxCollType)
  (A B : PaIn IdxCollType)
  (sofar : mergeT IdxCollType) (vals : List (PaIn IdxCollType)) : (mergeT IdxCollType) × (List (PaIn IdxCollType)) :=
  match A, B with
  ...
  | .br fvars mvars bvars sorts consts lits apf apa api laf laa lai alf ala ali lef lea lez lei projs proofsOf proofs,
    .br fvars' mvars' bvars' sorts' consts' lits' apf' apa' api' laf' laa' lai' alf' ala' ali' lef' lea' lez' lei' projs' proofsOf' proofs' =>
    let nf := CTrie.merge union fvars fvars'
    let nm := CTrie.merge union mvars mvars'
    ...
    let proto : PaIn IdxCollType := .br nf nm nb ns nc nli
    ...
    -- todo : optimize ↓
    let projs : CTrie ((ListProd IdxCollType (Nat × ((PaIn IdxCollType) × (PaIn IdxCollType))))) := projs.map (fun x => .some (x.mapTR (fun x (y,z) => (x,y,z,.dead))))
    let projs' : CTrie ((ListProd IdxCollType (Nat × ((PaIn IdxCollType) × (PaIn IdxCollType))))) := projs'.map (fun x => .some (x.mapTR (fun x (y,z) => (x,y,.dead,z))))
    let mproj := @CTrie.merge (ListProd IdxCollType (Nat × ((PaIn IdxCollType) × (PaIn IdxCollType)))) (fun l1 l2 =>
...
partial def mergeUp {IdxCollType : Type}
  ...
  (T : PaIn IdxCollType)
  (todo : mergeT IdxCollType) (vals : List (PaIn IdxCollType)) : PaIn IdxCollType :=
  match todo with
  | .nil => T
...
partial def merge
  (union : IdxCollType → IdxCollType → IdxCollType) (emptyCol : IdxCollType)
  (A B : PaIn IdxCollType) : PaIn IdxCollType :=
...
| nil
| done (_ : PaIn IdxCollType) (nx : cleanT IdxCollType)
| sig1 (nx : cleanT IdxCollType) | sig2 (nx : cleanT IdxCollType) | sig3 (nx : cleanT IdxCollType)
| apa (_ : PaIn IdxCollType) (nx : cleanT IdxCollType)
| laf (_ : PaIn IdxCollType) (nx : cleanT IdxCollType) | laa (_ : PaIn IdxCollType) (nx : cleanT IdxCollType)
| alf (_ : PaIn IdxCollType) (nx : cleanT IdxCollType) | ala (_ : PaIn IdxCollType) (nx : cleanT IdxCollType)
| lef (_ : PaIn IdxCollType) (nx : cleanT IdxCollType) | lea (_ : PaIn IdxCollType) (nx : cleanT IdxCollType) | lez (_ : PaIn IdxCollType) (nx : cleanT IdxCollType)
| projPre (_ : PaIn IdxCollType) (nx : cleanT IdxCollType)
| projPost (name : ByteArray) (idx : Nat) (is : IdxCollType) (nx : cleanT IdxCollType)
| proofsOf (_ : PaIn IdxCollType) (nx : cleanT IdxCollType)
| proofs (_ : PaIn IdxCollType) (nx : cleanT IdxCollType)
deriving Inhabited
...
partial def cleanDown (empty? : IdxCollType → Bool)
  (A : PaIn IdxCollType)
  (sofar : cleanT IdxCollType) (vals : List (PaIn IdxCollType)) : (cleanT IdxCollType) × (List (PaIn IdxCollType)) :=
  match A with
  | .dead => (.done A sofar,vals)
  | .br fvars mvars bvars sorts consts lits apf apa api laf laa lai alf ala ali lef lea lez lei projs proofsOf proofs =>
    let nt := (fvars.map (fun is => if empty? is then .none else .some is)).clean
    let nl := (mvars.map (fun is => if empty? is then .none else .some is)).clean
    ...
    let proto : PaIn IdxCollType := .br nt nl nb ns nc nli
      .dead .dead api .dead .dead lai .dead .dead ali .dead .dead .dead lei
      .empty .dead .dead
    let vals := proto :: vals
...
partial def cleanUp {IdxCollType : Type}
  ...
  (T : PaIn IdxCollType)
  (todo : cleanT IdxCollType) (vals : List (PaIn IdxCollType)) : PaIn IdxCollType :=
  match todo with
  | .nil => T
  ...
  | .sig3 nx =>
      ...
      | .br fvars mvars bvars sorts consts lits apf apa api laf laa lai alf ala ali lef lea lez lei projs proofsOf _ :: more =>
          if (match fvars with | .leaf => true | _ => false) && (match mvars with | .leaf => true | _ => false) && bvars.isEmpty && sorts.isEmpty &&
...
@[specialize, inline]
def deleteOfInds (T : PaIn IdxCollType) (inds : IdxCollType)
...
@[specialize, inline]
def keepOnlyOfInds (T : PaIn IdxCollType) (inds : IdxCollType)
